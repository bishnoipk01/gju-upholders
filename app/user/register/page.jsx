...
async function registerUser(e) {
  ...
  const passwordMatch = e.target.confirmPassword.value;
  if (password !== passwordMatch) return alert("password does not match");
  const result = await fetch(`${API_URI}users/register`, {
    method: "POST",
