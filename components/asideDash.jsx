...
export default function AsideDash({ active }) {
  ...
  return (
    <aside className='ml-[-100%] fixed z-10 top-20 pb-3 px-6 w-full flex flex-col justify-between h-[95vh]  bg-white transition duration-300 md:w-4/12 lg:ml-0 lg:w-[25%] xl:w-[20%] 2xl:w-[15%]'>
      <div>
